...
export const appRoute = {
  ...
  leaderboard: { name: appRouteName.leaderboard },
  ...
  crowdBoard: { name: appRouteName.crowdBoard },
...
const pathRouteMap: Record<string, RouteLocationRaw> = {
  ...
  '/community/leaderboard': appRoute.leaderboard,
  ...
  '/evidence/crowd-board': appRoute.crowdBoard,
...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    component: () => import('@/views/community/LeaderboardView.vue'),
    meta: {
      requiresAuth: true,
      layout: 'backend',
      pageGroup: '社区治理',
  ...
  {
    path: '/evidence/crowd-board',
    name: appRouteName.crowdBoard,
    component: () => import('@/views/evidence/CrowdBoardView.vue'),
    meta: {
      requiresAuth: true,
      layout: 'backend',
      pageGroup: '社区治理',
