<template>
  <section class="hotspot-card tech-panel">
...
.hotspot-card__summary-item.is-primary {
  background: color-mix(in srgb, var(--tech-color-primary-soft) 42%, rgba(255, 255, 255, 0.04));
...
.hotspot-card__summary-item.is-info {
  background: color-mix(in srgb, var(--tech-color-info-soft) 42%, rgba(255, 255, 255, 0.04));
